...
var SearchResult = React.createClass({
    ...
    componentDidMount: function (model) {
        ...
        var res = searchInputObj.replace(' ', '+');
            ...
            Parse.Cloud.run('productName', {search: searchInputObj}).then(function (response) {
            ...
            <div className="main">
                ...
                <ul className="results">
                {
                	this.state.product_name.map(function(productsList){
                		return <li><Link to={'/search-result/product/' + this.state.product_upc}>{productsList}></Link></li>
                	}.bind(this))
            }
				</ul>
                </div>
